...
local MENU_OPTIONS = {
    ...
    menu_subtitle = TranslateCap('document_options'),
    color_r = 0,
    color_g = 128,
    color_b = 255,
}
...
function OpenMainMenu()
    ClearMenu()
    Menu.addButton(TranslateCap('public_documents'), "OpenNewPublicFormMenu", nil)
    Menu.addButton(TranslateCap('job_documents'), "OpenNewJobFormMenu", nil)
    Menu.addButton(TranslateCap('saved_documents'), "OpenMyDocumentsMenu", nil)
    Menu.addButton(TranslateCap('close_bt'), "CloseMenu", nil)
    Menu.hidden = false
end
...
function ShowToNearestPlayers(aDocument)
    ...
    if #players_clean > 0 then
        ...
        Menu.addButton(TranslateCap('no_player_found'), "CloseMenu", nil)
    end
...
function CopyToNearestPlayers(aDocument)
    ...
    Menu.addButton(TranslateCap('go_back'), "OpenFormPropertiesMenu", aDocument)
    Menu.addButton(TranslateCap('close_bt'), "CloseMenu", nil)
end
...
function OpenFormPropertiesMenu(aDocument)
    ClearMenu()
    Menu.addButton(TranslateCap('view_bt'), "ViewDocument", aDocument.data)
    Menu.addButton(TranslateCap('show_bt'), "ShowToNearestPlayers", aDocument.data)
    Menu.addButton(TranslateCap('give_copy'), "CopyToNearestPlayers", aDocument.data)
    Menu.addButton(TranslateCap('delete_bt'), "OpenDeleteFormMenu", aDocument)
    Menu.addButton(TranslateCap('go_back'), "OpenMyDocumentsMenu", nil)
    Menu.addButton(TranslateCap('close_bt'), "CloseMenu", nil)
    Menu.hidden = false
end
...
function OpenDeleteFormMenu(aDocument)
    ClearMenu()
    Menu.addButton(TranslateCap('yes_delete'), "DeleteDocument", aDocument)
    Menu.addButton(TranslateCap('go_back'), "OpenFormPropertiesMenu", aDocument)
    Menu.addButton(TranslateCap('close_bt'), "CloseMenu", nil)
    Menu.hidden = false
end
